                             ...
                             <table border="0" class="table cust-table"> 
                               <thead>
                                   <tr style="width:80px;">
                                     ...
                                     <th style="width:120px;" class="text-center"><li class="fa fa-gear"></li></th>  
                                 ...
                                 <tbody>
                                   <tr>
                                     ...
                                     <td style="width:120px;" class="text-center"><button class="btn btn-outline-danger del-icon"><span class="fa fa-trash-o"></span></button> <button class="btn btn-outline-success"><span class="fa fa-pencil"></span></button></td>
